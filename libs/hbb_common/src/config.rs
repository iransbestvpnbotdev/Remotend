...
pub const LINK_DOCS_HOME: &str = "https://jobbusy.com";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://jobbusy.com";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://jobbusy.com";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("Remotend docs home", LINK_DOCS_HOME),
        ("Remotend docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("Remotend x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
